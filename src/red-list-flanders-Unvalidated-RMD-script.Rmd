---
title: "Darwin Core mapping UnValidated Red List Flanders"
...
raw_data_file <- "../data/raw/unvalidated/NonValidatedRedListsSource.csv"


# Processed files:

dwc_taxon_file <- "../data/processed/unvalidated/taxonUnValidatedList.csv"
dwc_distribution_file = "../data/processed/unvalidated/distributionUnValidatedList.csv"
```
