...
subtitle: "For: Validated Red Lists Flanders, Belgium"
author:
- Dimitri Brosens
- Lien Reyserhove
- Peter Desmet
...
```{r}
taxon %<>% mutate(threadStatus = recode(raw_rlc_as_published,
  ...
  "Uitgestorven in Vlaanderen" = 	"Regionally Extinct (EX) in Flanders",
