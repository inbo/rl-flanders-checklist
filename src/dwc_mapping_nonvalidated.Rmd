...
subtitle: "For: Non-validated red lists of Flanders, Belgium"
author:
- Dimitri Brosens
- Peter Desmet
- Lien Reyserhove
...
This document describes how we map the non-validated red list data for Flanders to Darwin Core. The source file for this document can be found [here](https://github.com/inbo/rl-flanders-checklist/blob/master/src/dwc_mapping_nonvalidated.Rmd).
